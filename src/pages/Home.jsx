  ...
  return (
    <div className="flex flex-col md:flex-row h-full w-full">
      <div className="flex flex-col justify-center items-center md:items-start w-full md:w-1/2 px-6 md:pl-16 text-[#DADADA] py-8 md:py-0 text-center md:text-left">
        <h1 className="text-3xl md:text-4xl font-bold">ELHAM NAKHKOOB</h1>
        <h2 className="text-xl md:text-2xl mt-2">FULLSTACK-DEVELOPER</h2>
        <p className="text-base md:text-lg mt-2">with UX/UI Experience</p>
      </div>
